...
import { validateUserCredentials, setSessionEmail } from "@/lib/auth";
        ...
        <div className="glass glass-hover rounded-[3rem] shadow-[0_32px_128px_-16px_rgba(0,0,0,0.7)] border-white/5 p-10 sm:p-14 backdrop-blur-3xl transition-all duration-700">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2.5">
                <div className="flex items-center justify-between px-1">
                  ...
                  <button
                    type="button"
                    className="text-[10px] font-black text-primary hover:text-primary-glow transition-colors uppercase tracking-widest"
                    onClick={() => toast("Fonctionnalité mot de passe oublié à venir.")}
                  >
                    Oublié ?
                  </button>
                </div>
          ...
          <div className="mt-12 flex flex-col items-center gap-8 border-t border-white/5 pt-10">
            <p className="flex items-center text-sm font-semibold">
              <span className="text-white/30">Nouveau ici ?</span>
              <Link
                to="/signup"
